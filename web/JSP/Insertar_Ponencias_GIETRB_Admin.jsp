    ...
    <head>
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Evento_Ponencia_GIETRB.focus();
                if ( servi.Evento_Ponencia_GIETRB.value == ""){
                    alert( "Faltan el Evento");
                    servi.Evento_Ponencia_GIETRB.focus();
                    return false;
                }
                if ( servi.Ciudad_Ponencia_GIETRB.value == ""){
                    alert( "Falta la Ciudad" );
                    servi.Ciudad_Ponencia_GIETRB.focus();
                    return false;
                }
                if ( servi.Pais_Ponencia_GIETRB.value == ""){
                    alert( "Falta el País" );
                    servi.Pais_Ponencia_GIETRB.focus();
                    return false;
                }
    ...
    <body>
        ...
        <form name="servi" method="post" action="Servlet_Proyectos_Admin"onSubmit="return verificar(this)">
                    ...
                    <table width="1034" height="214" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Evento_Ponencia_GIETRB" type="text" id="Evento_Ponencia_GIETRB" size="100" maxlength="150" class="Cajas" placeholder="Evento o ponencia...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Ano_Ponencia_GIETRB" type="text" class="Cajas" id="Ano_Ponencia_GIETRB" size="10" maxlength="4" placeholder="Escribe el año...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Ciudad_Ponencia_GIETRB" type="text" class="Cajas" id="Ciudad_Ponencia_GIETRB" size="30" maxlength="30" placeholder="Escribe la ciudad...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            <td height="40" bgcolor="#CCCCCC" class="Estilo6"><div align="center"><strong>PAÍS:</strong></div></td>
                            <td height="40" class="Estilo6"><input name="Pais_Ponencia_GIETRB" type="text" class="Cajas" id="Pais_Ponencia_GIETRB" size="30" maxlength="30" placeholder="Escribe el país..."></td>
                        </tr>
                        <tr>
                            <td height="40" bgcolor="#CCCCCC" class="Estilo6"><div align="center"><strong>GRUPO</strong></div></td>
                            <td height="40" class="Estilo6"><input name="Grupo_Ponencia_GIETRB" type="text" class="Cajas" id="Grupo_Ponencia_GIETRB" value="02" size="3" maxlength="3" readonly="readonly"></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                </div>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Guardar_Ponencia_GIETRB" type="submit" id="Guardar_Ponencia_GIETRB" value="Guardar" class="Boton" onclick="alert('Nueva ponencia agregada exitosamente')"/>
                </label>
                <label></label>
                <label></label>
            </p>
