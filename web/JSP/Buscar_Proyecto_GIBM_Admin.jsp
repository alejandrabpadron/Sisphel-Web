                ...
                <div class="hb-content-wrapper">
                    <div class="hb-text-wrapper">
                        <div class="hb-headline-text">
                            <p><span>Busca el proyecto de investigación a modificar.</span></p>
                        </div>
                    </div>
                </div>
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Pro_GIBM" type="text" class="Boton21" id="Nombre_Pro_GIBM"placeholder="Nombre del proyecto...">
                                </span>
                            </span>
