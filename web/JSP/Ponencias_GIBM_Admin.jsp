        ...
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <center><div>
                    ...
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            <td width="402" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">EVENTO</div>
                          </div></td>
                          <td width="153" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">AÑO</div></td>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Insertar_Ponencia_GIBM" type="submit" id="Insertar_Ponencia_GIBM" value="Insertar" class="Boton"/>
                </label>
                <label>
                    <input name="Modificar_Ponencia_GIBM" type="submit" id="Modificar_Ponencia_GIBM" value="Modificar" class="Boton"/>
                </label>
