    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Insertar_Produccion_GIETRB" type="submit" id="Insertar_Produccion_GIETRB" value="Insertar" class="Boton"/>
                </label>
                <label>
                    <input name="Modificar_Produccion_GIETRB" type="submit" id="Modificar_Produccion_GIETRB" value="Modificar" class="Boton"/>
                </label>
                <label>
                    <input name="Eliminar_Produccion_GIETRB" type="submit" id="Eliminar_Produccion_GIETRB" value="Eliminar" class="Boton"/>
                </label>
            </p>
        </form>
    </body>
