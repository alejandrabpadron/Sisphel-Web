    ...
    <head>
        ...
        <script language="javascript">
            ...
            function EnviarID(Codigo){
                var ab=Codigo;
                window.open ("/SisphelWeb/JSP/Modificar_Proyectos_GIBM_Admin.jsp?Mod_Codigo="+ab, "mywindow");
            }
        </script>
            ...
            <center><div>
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        ...
                        <tr>
                            ...
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getNombre_Pro_GIBM()%></span></div></td>
