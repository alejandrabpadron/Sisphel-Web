    ...
    <head>
        ...
        <script language="javascript">
            ...
            function EnviarID(Codigo){
                var ab=Codigo;
                window.open ("/SisphelWeb/JSP/Modificar_Premios_GIBM_Admin.jsp?Mod_Codigo="+ab, "mywindow");
            }
        </script>
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Prod_GIBM" type="text" class="Boton21" id="Nombre_Prod_GIBM">
                                </span>
                            </span>
            ...
            <center><div>
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        ...
                        <tr>
                            ...
                            <td><div align="center" class="Estilo6"><%=p.getNombre_Pre_GIBM()%></div></td>
