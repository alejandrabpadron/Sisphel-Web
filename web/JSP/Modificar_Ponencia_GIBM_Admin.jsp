        ...
        <form name="form1" method="post" action="/SisphelWeb/Servlet_Proyectos_Admin">
            ...
            <center><div>
                    ...
                    <%String Pon = (String) request.getParameter("Mod_Codigo");
                                Vector x;
                                x = Ponencia_Modificar_GIBM.DatosGIBM(Pon);
                                Ponencia_Modificar_GIBM p = (Ponencia_Modificar_GIBM) x.get(0);
                    ...
                    <table width="1034" height="40" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="ID_Ponencia_GIBM" type="text" id="ID_Ponencia_GIBM" size="10" maxlength="4" class="Cajas" readonly="readonly"   value="<%=p.getID()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Evento_Ponencia_GIBM" type="text" id="Evento_Ponencia_GIBM" size="100" maxlength="150" class="Cajas" placeholder="Evento o ponencia..."value="<%=p.getNombre_Pon_GIBM()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Ano_Ponencia_GIBM" type="text" class="Cajas" id="Ano_Ponencia_GIBM" size="10" maxlength="4" placeholder="Escribe el año..."value="<%=p.getAño()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Ciudad_Ponencia_GIBM" type="text" class="Cajas" id="Ciudad_Ponencia_GIBM" size="30" maxlength="30" placeholder="Escribe la ciudad..."value="<%=p.getCiudad()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            <td height="40" bgcolor="#CCCCCC" class="Estilo6"><div align="center"><strong>PAÍS:</strong></div></td>
                            <td height="40" class="Estilo6"><input name="Pais_Ponencia_GIBM" type="text" class="Cajas" id="Pais_Ponencia_GIBM" size="30" maxlength="30" placeholder="Escribe el país..."value="<%=p.getPais()%>"></td>
                        </tr>
                        <tr>
                            <td height="40" bgcolor="#CCCCCC" class="Estilo6"><div align="center"><strong>GRUPO:</strong></div></td>
                            <td height="40" class="Estilo6"><input name="Grupo_Ponencia_GIBM" type="text" class="Cajas" id="Grupo_Ponencia_GIBM" size="3" maxlength="3"value="<%=p.getGrupo()%>"placeholder="Grupo..." onkeypress="if(event.keyCode<=45 || event.keyCode>57) event.returnValue=false;"></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                </div>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Actualizar_Ponencia_GIBM" type="submit" id="Actualizar_Ponencia_GIBM" value="Actualizar" class="Boton" onclick="confirmacion();"/>
                </label>
                <label></label>
                <label></label>
            </p>
