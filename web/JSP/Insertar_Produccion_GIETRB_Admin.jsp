    ...
    <head>
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Autores_Produccion_GIETRB.focus();
                if ( servi.Autores_Produccion_GIETRB.value == ""){
                    alert( "Faltan los Autores");
                    servi.Autores_Produccion_GIETRB.focus();
                    return false;
                }
                if ( servi.Titulo_Produccion_GIETRB.value == ""){
                    alert( "Falta el Título" );
                    servi.Titulo_Produccion_GIETRB.focus();
                    return false;
                }
                if ( servi.Tipo_Produccion_GIETRB.value == ""){
                    alert( "Falta el Tipo de Publicación" );
                    servi.Tipo_Produccion_GIETRB.focus();
                    return false;
                }
                return true;
            }
        ...
        <title>Nueva Producción Científica</title>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">NUEVA PRODUCCIÓN CIENTÍFICA</h1></div>
            <br>
            <div id="obj2">
        ...
        <form name="servi" method="post" action="Servlet_Proyectos_Admin"onSubmit="return verificar(this)">
            <center><div>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <table width="1034" height="298" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Autores_Produccion_GIETRB" type="text" id="Autores_Produccion_GIETRB" size="100" maxlength="150" class="Cajas" placeholder="Autores del avance científico...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Grupo_Produccion_GIETRB" type="text" class="Cajas" id="Grupo_Produccion_GIETRB" value="02" size="3" maxlength="3" readonly="readonly">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Titulo_Produccion_GIETRB" type="text" class="Cajas" id="Titulo_Produccion_GIETRB" size="100" maxlength="150" placeholder="Título de la producción científica...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><div align="left">
                                    <input name="Revista_Produccion_GIETRB" type="text" class="Cajas" id="Revista_Produccion_GIETRB" size="50" maxlength="50" placeholder="Journal o revista...">
                                </div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><div align="left">
                                    <input name="Ano_Produccion_GIETRB" type="text" class="Cajas" id="Ano_Produccion_GIETRB" size="10" maxlength="4" placeholder="Año de publicación...">
                                </div></td>
                        </tr>
                        <tr>
                            <td height="40" bgcolor="#CCCCCC" class="Estilo6"><div align="center"><strong>SITIO WEB - URL </strong></div></td>
                            <td height="40" class="Estilo6"><input name="Url_Produccion_GIETRB" type="text" class="Cajas" id="Url_Produccion_GIETRB" size="80" maxlength="80" placeholder="Sitio web..."></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                </div>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Guardar_Produccion_GIETRB" type="submit" id="Guardar_Produccion_GIETRB" value="Guardar" class="Boton" onclick="alert('Nueva producción científica agregada exitosamente')"/>
                </label>
                <label></label>
                <label></label>
            </p>
