<%@page import="Operaciones.Proyecto_Modificar_GIBM"%>
    ...
    <head>
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                ...
                if ( servi.Grupo_Proyecto_GIBM.value == ""){
                    alert( "Falta el Grupo del Proyecto" );
                    servi.Grupo_Proyecto_GIBM.focus();
                    return false;
                }
                return true;
            }
        ...
        <form name="form1" method="post" action="/SisphelWeb/Servlet_Proyectos_Admin">
            ...
            <center><div>
                    ...
                    <%String Pro = (String) request.getParameter("Mod_Codigo");
                                Vector x;
                                x = Proyecto_Modificar_GIBM.DatosGIBM(Pro);
                                Proyecto_Modificar_GIBM p = (Proyecto_Modificar_GIBM) x.get(0);
                    ...
                    <table width="1034" height="40" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="ID_Proyecto_GIBM" type="text" id="ID_Proyecto_GIBM" size="10" maxlength="4" class="Cajas" readonly="readonly"   value="<%=p.getID()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Titulo_Proyecto_GIBM" type="text" id="Titulo_Proyecto_GIBM" size="100" maxlength="250" class="Cajas" placeholder="Nombre del proyecto..."value="<%=p.getNombre_Pro_GIBM()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Grupo_Proyecto_GIBM" type="text" class="Cajas" id="Grupo_Proyecto_GIBM" value="<%=p.getGrupo()%>" size="3" maxlength="3"placeholder="Grupo..." onkeypress="if(event.keyCode<=45 || event.keyCode>57) event.returnValue=false;">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <select name="Estado_Proyecto_GIBM" class="Cajas">
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Actualizar_Proyecto_GIBM" type="submit" id="Actualizar_Proyecto_GIBM" value="Actualizar" class="Boton" onclick="confirmacion();"/>
                </label>
                <label></label>
                <label></label>
            </p>
