        ...
        <form name="form1" method="post" action="/SisphelWeb/Servlet_Proyectos_Admin">
            ...
            <center><div>
                    ...
                    <%String Pro = (String) request.getParameter("Mod_Codigo");
                                Vector x;
                                x = Produccion_Modificar_GIBM.DatosGIBM(Pro);
                                Produccion_Modificar_GIBM p = (Produccion_Modificar_GIBM) x.get(0);
                    ...
                    <table width="1034" height="40" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="ID_Produccion_GIBM" type="text" id="ID_Produccion_GIBM" size="10" maxlength="4" class="Cajas" readonly="readonly"   value="<%=p.getID()%>">
                                    </div>
                                </label></td>
                        </tr>
                        ...
                        <td width="250" height="40" class="Estilo6"><label>
                                ...
                                <div align="left">
                                    <input name="Autores_Produccion_GIBM" type="text" id="Autores_Produccion_GIBM" size="100" maxlength="150" class="Cajas" placeholder="Autores del avance científico..."value="<%=p.getAutores()%>">
                                </div>
                            </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Grupo_Produccion_GIBM" type="text" class="Cajas" id="Grupo_Produccion_GIBM" size="3" maxlength="3"value="<%=p.getGrupo()%>"placeholder="Grupo..." onkeypress="if(event.keyCode<=45 || event.keyCode>57) event.returnValue=false;">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Titulo_Produccion_GIBM" type="text" class="Cajas" id="Titulo_Produccion_GIBM" size="100" maxlength="150" placeholder="Título de la producción científica..."value="<%=p.getNombre_Prod_GIBM()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><div align="left">
                                    <input name="Revista_Produccion_GIBM" type="text" class="Cajas" id="Revista_Produccion_GIBM" size="50" maxlength="50" placeholder="Journal o revista..."value="<%=p.getRevista()%>">
                                </div></td>
                        </tr>
                        <tr>
                            <td height="40" bgcolor="#CCCCCC" class="Estilo6"><div align="center"><strong>TIPO DE PUBLICACIÓN </strong></div></td>
                            <td height="40" class="Estilo6"><div align="left">
                                    <select name="Tipo_Produccion_GIBM" class="Cajas">
                        ...
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><div align="left">
                                    <input name="Ano_Produccion_GIBM" type="text" class="Cajas" id="Ano_Produccion_GIBM" size="10" maxlength="4" placeholder="Año de publicación..."value="<%=p.getAño()%>">
                                </div></td>
                        </tr>
                        <tr>
                            <td height="40" bgcolor="#CCCCCC" class="Estilo6"><div align="center"><strong>SITIO WEB - URL </strong></div></td>
                            <td height="40" class="Estilo6"><input name="Url_Produccion_GIBM" type="text" class="Cajas" id="Url_Produccion_GIBM" size="80" maxlength="80" placeholder="Sitio web..."value="<%=p.getUrl()%>"></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                </div>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Actualizar_Produccion_GIBM" type="submit" id="Actualizar_Produccion_GIBM" value="Actualizar" class="Boton" onclick="confirmacion();"/>
                </label>
                <label></label>
                <label></label>
            </p>
