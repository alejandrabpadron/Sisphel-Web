    ...
    <head>
        ...
        <script language="javascript">
            ...
            function EnviarID(Codigo){
                var ab=Codigo;
                window.open ("/SisphelWeb/JSP/Modificar_Ponencia_GIBM_Admin.jsp?Mod_Codigo="+ab, "mywindow");
            }
        </script>
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Pon_GIBM" type="text" class="Boton21" id="Nombre_Pon_GIBM">
                                </span>
                            </span>
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Ponencia_GIBM" type="submit" id="Buscar_Ponencia_GIBM" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
            ...
            <center><div>
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        ...
                        <tr>
                            ...
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getNombre_Pon_GIBM()%></span></div></td>
