...
<html>
    ...
    <head>
        ...
        <title>Búsqueda de Proyectos de Investigación</title>
        <link rel="icon" type="image/png" href="Img/ICONO.png"/>
        <script language="javascript">

            function EnviarID(Codigo){
                var ab=Codigo;
                window.open ("/SisphelWeb/JSP/Modificar_Proyectos_GIETRB_Admin.jsp?Mod_Codigo="+ab, "mywindow");
            }
        </script>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
                ...
                <div class="hb-content-wrapper">
                    <div class="hb-text-wrapper">
                        <div class="hb-headline-text">
                            <p><span>Selecciona el proyecto de investigación a modificar.</span></p>
                        </div>
                    </div>
                </div>
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">MODIFICAR PROYECTOS DE INVESTIGACIÓN</h1></div>
            <br>
            <div id="obj2">
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Pro_GIBM" type="text" class="Boton21" id="Nombre_Pro_GIBM">
                                </span>
                            </span>
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Proyecto_GIBM" type="submit" id="Buscar_Proyecto_GIBM" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
            ...
            <center><div>
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            <td width="109" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">ID</div>
                                </div></td>
                            <td width="642" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">NOMBRE</div>
                                </div></td>
                            <td width="371" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">ESTADO</div></td>
                        </tr> 
                        <%
                                    Vector e;
                                    e = (Vector) request.getAttribute("Proyectos");
                                    for (int i = 0; i < e.size(); i++) {

                                        Buscar_Proyectos p = (Buscar_Proyectos) e.get(i);

                        %>
                        <tr>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><a href="javascript:EnviarID('<%=p.getID()%>');"/><%=p.getID()%></span></div></td>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getNombre_Pro_GIETRB()%></span></div></td>
                            <td><div align="center" class="Estilo6"></div>
                                <div align="center"><span class="Estilo6"><%=p.getEstado()%></span></div></td>
                        </tr> <%
                                    }
                        %>
                    </table>
