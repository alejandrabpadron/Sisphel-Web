    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Insertar_Premios_GIBM" type="submit" id="Insertar_Premios_GIBM" value="Insertar" class="Boton"/>
                </label>
                <label>
                    <input name="Modificar_Premios_GIBM" type="submit" id="Modificar_Premios_GIBM" value="Modificar" class="Boton"/>
                </label>
            </p>
        </form>
    </body>
