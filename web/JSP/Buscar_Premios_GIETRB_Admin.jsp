    ...
    <head>
        ...
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Nombre_Pre_GIBM.focus();
                if ( servi.Nombre_Pre_GIBM.value == ""){
                    alert( "Faltan el Premio");
                    servi.Nombre_Pre_GIBM.focus();
                    return false;
                }
                return true;
                ...
                <div class="hb-content-wrapper">
                    <div class="hb-text-wrapper">
                        <div class="hb-headline-text">
                            <p><span>Busca el premio o distinción a modificar.</span></p>
                        </div>
                    </div>
                </div>
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Pre_GIETRB" type="text" class="Boton21" id="Nombre_Pre_GIETRB"placeholder="Nombre del premio...">
                                </span>
                            </span>
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Premio_GIETRB" type="submit" id="Buscar_Premio_GIETRB" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
