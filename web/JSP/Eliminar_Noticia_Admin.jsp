...
<html>
    ...
    <body>
        <form name="form1" method="post" action="/SisphelWeb/Servlet_Proyectos_Admin">
            ...
            <br>
            <div id="obj2">
                <h3 align="center">Eliminar Noticia</h3>
            </div>
            <center><div>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>

                    <%String Not = (String) request.getParameter("Eli_Codigo");
                                Vector x;
                    ...
                    <table width="1034" height="40" align="center">
                        ...
                        <td width="725" height="40" class="Estilo6"><label>
                                <div align="left">
                                    <input name="Titulo_Noticia" type="text" class="Cajas" id="Titulo_Noticia" size="100" maxlength="100"value="<%=p.getNombre_Noticia()%>"readonly="readonly">
                                </div>
                            </label></td>
                        </tr>
                    </table>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Eliminar_Noticia" type="submit" id="Eliminar_Noticia" value="Eliminar" class="Boton" onclick="alert('Noticia eliminada')"/>
                </label>
                <label></label>
                <label></label>
            </p>
