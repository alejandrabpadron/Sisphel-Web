    ...
    <head>
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Autores_Produccion_GIBM.focus();
                if ( servi.Autores_Produccion_GIBM.value == ""){
                    alert( "Faltan los Autores");
                    servi.Autores_Produccion_GIBM.focus();
                    return false;
                }
                if ( servi.Titulo_Produccion_GIBM.value == ""){
                    alert( "Falta el Título" );
                    servi.Titulo_Produccion_GIBM.focus();
                    return false;
                }
                if ( servi.Tipo_Produccion_GIBM.value == ""){
                    alert( "Falta el Tipo de Publicación" );
                    servi.Tipo_Produccion_GIBM.focus();
                    return false;
                }
                return true;
            }
    ...
    <body>
        ...
        <form name="servi" method="post" action="Servlet_Proyectos_Admin"onSubmit="return verificar(this)">
                    ...
                    <table width="1034" height="298" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Autores_Produccion_GIBM" type="text" id="Autores_Produccion_GIBM" size="100" maxlength="150" class="Cajas" placeholder="Autores del avance científico...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Grupo_Produccion_GIBM" type="text" class="Cajas" id="Grupo_Produccion_GIBM" value="01" size="3" maxlength="3" readonly="readonly">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Titulo_Produccion_GIBM" type="text" class="Cajas" id="Titulo_Produccion_GIBM" size="100" maxlength="150" placeholder="Título de la producción científica...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><div align="left">
                                    <input name="Revista_Produccion_GIBM" type="text" class="Cajas" id="Revista_Produccion_GIBM" size="50" maxlength="50" placeholder="Journal o revista...">
                                </div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><div align="left">
                                    <input name="Ano_Produccion_GIBM" type="text" class="Cajas" id="Ano_Produccion_GIBM" size="10" maxlength="4" placeholder="Año de publicación...">
                                </div></td>
                        </tr>
                        <tr>
                            <td height="40" bgcolor="#CCCCCC" class="Estilo6"><div align="center"><strong>SITIO WEB - URL </strong></div></td>
                            <td height="40" class="Estilo6"><input name="Url_Produccion_GIBM" type="text" class="Cajas" id="Url_Produccion_GIBM" size="80" maxlength="80" placeholder="Sitio web..."></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                </div>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Guardar_Produccion_GIBM" type="submit" id="Guardar_Produccion_GIBM" value="Guardar" class="Boton" onclick="alert('Nueva producción científica agregada exitosamente')"/>
                </label>
                <label></label>
                <label></label>
            </p>
