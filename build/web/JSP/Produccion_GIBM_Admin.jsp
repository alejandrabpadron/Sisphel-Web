        ...
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <center><div>
                    ...
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            <td width="197" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">AUTORES</div>
                          </div></td>
                            <td width="311" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">TÍTULO</div></td>
                            <td width="190" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">REVISTA-JOURNAL</div>
                          </div></td>
                          <td width="180" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">TIPO DE PUBLICACIÓN</div></td>
                            <td width="101" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">AÑO</div>
                          </div></td>
                          <td width="125" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">SITIO WEB</div></td>
                        </tr>
                        <%Vector e;
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Insertar_Produccion_GIBM" type="submit" id="Insertar_Produccion_GIBM" value="Insertar" class="Boton"/>
                </label>
                <label>
                    <input name="Modificar_Produccion_GIBM" type="submit" id="Modificar_Produccion_GIBM" value="Modificar" class="Boton"/>
                </label>
                <label>
                    <input name="Eliminar_Produccion_GIBM" type="submit" id="Eliminar_Produccion_GIBM" value="Eliminar" class="Boton"/>
                </label>
            </p>
        </form>
    </body>
