    ...
    <head>
        ...
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Nombre_Prod_GIETRB.focus();
                ...
                <div class="hb-content-wrapper">
                    <div class="hb-text-wrapper">
                        <div class="hb-headline-text">
                            <p><span>Busca la producción científica a eliminar.</span></p>
                        </div>
                    </div>
                </div>
                    ...
                    <label>
                        <div class="Buscar">   
                            ...
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Eliminar_GIETRB" type="submit" id="Buscar_Eliminar_GIETRB" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
