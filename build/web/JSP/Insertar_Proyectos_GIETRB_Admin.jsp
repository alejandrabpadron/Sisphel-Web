    ...
    <head>
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Titulo_Proyecto_GIETRB.focus();
                if ( servi.Titulo_Proyecto_GIETRB.value == ""){
                    alert( "Falta el Título del Proyecto");
                    servi.Titulo_Proyecto_GIETRB.focus();
                    return false;
                }
                if ( servi.Estado_Proyecto_GIETRB.value == ""){
                    alert( "Falta el Estado del Proyecto" );
                    servi.Estado_Proyecto_GIETRB.focus();
                    return false;
                }
                return true;
            }
        ...
        <title>Nuevo Proyecto de Investigación</title>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">NUEVO PROYECTO DE INVESTIGACIÓN</h1></div>
            <br>
            <div id="obj2">
        ...
        <form name="servi" method="post" action="Servlet_Proyectos_Admin" onSubmit="return verificar(this)">
                    ...
                    <table width="1034" height="40" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Titulo_Proyecto_GIETRB" type="text" id="Titulo_Proyecto_GIETRB" size="100" maxlength="250" class="Cajas" placeholder="Nombre del proyecto...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Grupo_Proyecto_GIETRB" type="text" class="Cajas" id="Grupo_Proyecto_GIETRB" value="02" size="3" maxlength="3" readonly="readonly">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Guardar_Proyecto_GIETRB" type="submit" id="Guardar_Proyecto_GIETRB" value="Guardar" class="Boton"onclick="alert('Nuevo proyecto agregado exitosamente')"/>
                </label>
                <label></label>
                <label></label>
            </p>
