<%@page import="Operaciones.Consultar_Ponencias"%>
...
<html>
    ...
    <head>
        ...
        <title>Ponencias y Eventos</title>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">PONENCIAS Y EVENTOS</h1></div>
            <br>
            <div id="obj2">
            ...
            <center><div>
                    ...
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            <td width="396" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">EVENTO</div>
                          </div></td>
                          <td width="159" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">AÑO</div></td>
                            <td width="285" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">CIUDAD</div>
                          </div></td>
                            <td width="276" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">PAÍS</div></td>
                        </tr>
                        <%Vector e;
                                    ...
                                    for (int i = 0; i < e.size(); i++) {
                                        ...
                                        Consultar_Ponencias p = (Consultar_Ponencias) e.get(i);
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Insertar_Ponencias_GIETRB" type="submit" id="Insertar_Ponencias_GIETRB" value="Insertar" class="Boton"/>
                </label>
                <label>
                    <input name="Modificar_Ponencia_GIETRB" type="submit" id="Modificar_Ponencia_GIETRB" value="Modificar" class="Boton"/>
                </label>
            </p>
        </form>
    </body>
