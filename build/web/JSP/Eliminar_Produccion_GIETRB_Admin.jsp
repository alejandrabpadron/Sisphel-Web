    ...
    <head>
         ...
         <script>
            function confirmacion(){
                alert("Producción científica eliminada");
            }
        </script>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Eliminar Producción Científica</title>
    ...
    <body>
        <form name="form1" method="post" action="/SisphelWeb/Servlet_Proyectos_Admin">
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">ELIMINAR PRODUCCIÓN CIENTÍFICA</h1></div>
            <br>
            <div id="obj2">
            ...
            <center><div>
                    ...
                    <%String Pro = (String) request.getParameter("Eli_Codigo");
                                Vector x;
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Eliminar_Prod_GIETRB" type="submit" id="Eliminar_Prod_GIETRB" value="Eliminar" class="Boton" onclick="confirmacion();"/>
                </label>
                <label></label>
                <label></label>
            </p>
