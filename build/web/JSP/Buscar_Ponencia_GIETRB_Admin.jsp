    ...
    <head>
        ...
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Nombre_Pon_GIBM.focus();
                if ( servi.Nombre_Pon_GIBM.value == ""){
                    alert( "Faltan del Evento");
                    servi.Nombre_Pon_GIBM.focus();
                    return false;
                }
                return true;
                ...
                <div class="hb-content-wrapper">
                    <div class="hb-text-wrapper">
                        <div class="hb-headline-text">
                            <p><span>Busca la ponencia o evento a modificar.</span></p>
                        </div>
                    </div>
                </div>
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Pon_GIETRB" type="text" class="Boton21" id="Nombre_Pon_GIETRB"placeholder="Nombre del evento...">
                                </span>
                            </span>
