    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Insertar_Proyecto_GIBM" type="submit" id="Insertar_Proyecto_GIBM" value="Insertar" class="Boton"/>
                </label>
                <label>
                    <input name="Modificar_Proyecto_GIBM" type="submit" id="Modificar_Proyecto_GIBM" value="Modificar" class="Boton"/>
                </label>
            </p>
        </form>
    </body>
