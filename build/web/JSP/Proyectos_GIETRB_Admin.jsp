<%@page import="Operaciones.Consultar_Proyectos"%>
...
<html>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin" onSubmit="return verificar(this)">
            <br>
            <div class="logo">
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">PROYECTOS DE INVESTIGACIÓN</h1></div>
            <br>
            <div id="obj2">
            ...
            <center><div>
                    ...
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            ...
                            <td width="551" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">ESTADO</div></td>
                        </tr>
                        <%Vector e;
                                    ...
                                    for (int i = 0; i < e.size(); i++) {
                                        ...
                                        Consultar_Proyectos p = (Consultar_Proyectos) e.get(i);


                        %>
                        <tr>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getNombre()%></span></div></td>
                            <td><div align="center" class="Estilo6"><%=p.getEstado()%></div></td>
                        </tr>
                        <%
                                    }
                        %>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Insertar_Proyecto_GIETRB" type="submit" id="Insertar_Proyecto_GIETRB" value="Insertar" class="Boton"/>
                </label>
                <label>
                    <input name="Modificar_Proyecto_GIETRB" type="submit" id="Modificar_Proyecto_GIETRB" value="Modificar" class="Boton"/>
                </label>
            </p>
        </form>
    </body>
