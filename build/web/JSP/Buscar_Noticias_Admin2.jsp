<%@page import="Operaciones.Buscar_Noticias"%>
...
<html>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function EnviarID(Codigo){
                var ab=Codigo;
                window.open ("/SisphelWeb/JSP/Modificar_Noticia_Admin.jsp?Mod_Codigo="+ab, "mywindow");
            }
        </script>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <br>
            <div id="obj2">
                <h3 align="center">Selecciona Noticia a Editar</h3>
            </div><p>&nbsp;</p>
        </form>
                    ...
                    <label>
                        <div class="Buscar">   
                            ...
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Noticias" type="submit" id="Buscar_Noticias" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
            ...
            <center><div>
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            ...
                            <td width="79" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">ID</div>
                                </div></td>
                            <td width="105" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">FECHA</div>
                                </div></td>
                            <td width="317" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">TÍTULO</div></td>
                            <td width="166" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">CÓDIGO UNISINÚ</div>
                                </div></td>
                            <td width="443" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">CUERPO</div></td>
                            <td width="443" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">IMAGEN</div></td>
                        </tr>
                        <%
                                    Vector e;
                                    ...
                                    for (int i = 0; i < e.size(); i++) {
                                        ...
                                        Buscar_Noticias p = (Buscar_Noticias) e.get(i);

                        %>
                        <tr>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><a href="javascript:EnviarID('<%=p.getID()%>');"/><%=p.getID()%></span></div></td>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getFecha()%></span></div></td>
                            <td><div align="center" class="Estilo6"><%=p.getNombre_Noticias()%></div></td>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getCodigo()%></span></div></td>
                            <td><div align="center" class="Estilo6">
                                    <div align="justify"><%=p.getCuerpo()%></div>
                                </div></td>
                            <td><div align="center" class="Estilo6">
                                    <div align="center"><img src="<%=p.getImagen()%>" width="120"></div>
                                </div></td>
                        </tr> <%
                                    }
                        %>
