<%@page import="Operaciones.Buscar_Ponencia"%>
...
<html>
    ...
    <head>
        ...
        <title>Búsqueda de Ponencias y Eventos</title>
        <link rel="icon" type="image/png" href="Img/ICONO.png"/>
        <script language="javascript">

            function EnviarID(Codigo){
                var ab=Codigo;
                window.open ("/SisphelWeb/JSP/Modificar_Ponencia_GIETRB_Admin.jsp?Mod_Codigo="+ab, "mywindow");
            }
        </script>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
                ...
                <div class="hb-content-wrapper">
                    <div class="hb-text-wrapper">
                        <div class="hb-headline-text">
                            <p><span>Selecciona la ponencia o evento a modificar.</span></p>
                        </div>
                    </div>
                </div>
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">MODIFICAR PONENCIAS Y EVENTOS</h1></div>
            <br>
            <div id="obj2">
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Pon_GIETRB" type="text" class="Boton21" id="Nombre_Pon_GIETRB">
                                </span>
                            </span>
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Ponencia_GIETRB" type="submit" id="Buscar_Ponencia_GIETRB" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
            ...
            <center><div>
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            ...
                            <td width="548" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">ID</div>
                                </div></td>
                            <td width="548" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">EVENTO</div>
                                </div></td>
                            <td width="551" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">AÑO</div></td>
                            <td width="548" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">CIUDAD</div>
                                </div></td>
                            <td width="551" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">PAÍS</div></td>

                        </tr> 
                        <%
                                    Vector e;
                                    e = (Vector) request.getAttribute("Ponencias");
                                    for (int i = 0; i < e.size(); i++) {

                                        Buscar_Ponencia p = (Buscar_Ponencia) e.get(i);

                        %>
                        <tr>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><a href="javascript:EnviarID('<%=p.getID()%>');"/><%=p.getID()%></span></div></td>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getNombre_Pon_GIETRB()%></span></div></td>
                            <td><div align="center" class="Estilo6"><%=p.getAño()%></div></td>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getCiudad()%></span></div></td>
                            <td><div align="center" class="Estilo6"><%=p.getPais()%></div></td>
                        </tr> <%
                                    }
                        %>
                    </table>
