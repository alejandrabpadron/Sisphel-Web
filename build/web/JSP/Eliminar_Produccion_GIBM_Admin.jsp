    ...
    <body>
        <form name="form1" method="post" action="/SisphelWeb/Servlet_Proyectos_Admin">           
            ...
            <center><div>
                    ...
                    <table width="1034" height="40" align="center">
                        ...
                        <td width="250" height="40" class="Estilo6"><label>
                                ...
                                <div align="left">
                                    <input name="Autores_Produccion_GIBM" type="text" id="Autores_Produccion_GIBM" size="100" maxlength="150" class="Cajas" readonly="readonly" placeholder="Autores del avance científico..."value="<%=p.getAutores()%>">
                                </div>
                            </label></td>
                        </tr>                  
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Titulo_Produccion_GIBM" type="text" class="Cajas" id="Titulo_Produccion_GIBM" size="100" maxlength="150" readonly="readonly" placeholder="Título de la producción científica..."value="<%=p.getNombre_Prod_GIBM()%>">
                                    </div>
                                </label></td>
                        </tr>                   
                    </table>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Eliminar_Prod_GIBM" type="submit" id="Eliminar_Prod_GIBM" value="Eliminar" class="Boton" onclick="confirmacion();"/>
                </label>
                <label></label>
                <label></label>
            </p>
