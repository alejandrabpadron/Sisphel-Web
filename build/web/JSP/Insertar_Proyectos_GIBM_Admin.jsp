    ...
    <body>
        ...
        <form name="servi" method="post" action="Servlet_Proyectos_Admin"onSubmit="return verificar(this)">
                    ...
                    <table width="1034" height="40" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Titulo_Proyecto_GIBM" type="text" id="Titulo_Proyecto_GIBM" size="100" maxlength="250" class="Cajas" placeholder="Nombre del proyecto...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Grupo_Proyecto_GIBM" type="text" class="Cajas" id="Grupo_Proyecto_GIBM" value="01" size="3" maxlength="3" readonly="readonly">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Guardar_Proyecto_GIBM" type="submit" id="Guardar_Proyecto_GIBM" value="Guardar" class="Boton" onclick="alert('Nuevo proyecto agregado exitosamente')"/>
                </label>
                <label></label>
                <label></label>
            </p>
