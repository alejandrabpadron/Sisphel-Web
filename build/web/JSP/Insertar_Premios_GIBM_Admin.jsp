    ...
    <head>
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Evento_Premios_GIBM.focus();
                if ( servi.Evento_Premios_GIBM.value == ""){
                    alert( "Faltan el Evento");
                    servi.Evento_Premios_GIBM.focus();
                    return false;
                }
                if ( servi.Premios_Premios_GIBM.value == ""){
                    alert( "Falta el Premio o Distincion" );
                    servi.Premios_Premios_GIBM.focus();
                    return false;
                }
                if ( servi.Trabajo_Premios_GIBM.value == ""){
                    alert( "Falta el Trabajo o Proyecto" );
                    servi.Trabajo_Premios_GIBM.focus();
                    return false;
                }
                if ( servi.Categoria_Premios_GIBM.value == ""){
                    alert( "Falta la Categoría" );
                    servi.Categoria_Premios_GIBM.focus();
                    return false;
                }
                return true;
            }
        ...
        <form name="servi" method="post" action="Servlet_Proyectos_Admin"onSubmit="return verificar(this)">
                    ...
                    <table width="1034" height="214" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Evento_Premios_GIBM" type="text" id="Evento_Premios_GIBM" size="100" maxlength="150" class="Cajas" placeholder="Evento que lo otorga...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Premios_Premios_GIBM" type="text" class="Cajas" id="Premios_Premios_GIBM" size="30" maxlength="30" placeholder="Premio obtenido...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Trabajo_Premios_GIBM" type="text" class="Cajas" id="Trabajo_Premios_GIBM" size="100" maxlength="150" placeholder="Trabajo o proyecto...">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><input name="Grupo_Premios_GIBM" type="text" class="Cajas" id="Grupo_Premios_GIBM" value="01" size="3" maxlength="3" readonly="readonly"></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                </div>
            ...
            <p align="center" class="Boton">
                <label><span class="Boton1">
                        <input name="Guardar_Premios_GIBM" type="submit" id="Guardar_Premios_GIBM" value="Guardar" class="Boton1" onclick="alert('Nuevo premio agregado exitosamente')"/>
                    </span></label>
                <label></label>
                <label></label>
            </p>
