        ...
        <form name="form1" method="post" action="/SisphelWeb/Servlet_Proyectos_Admin">
            ...
            <center><div>
                    ...
                    <%String Pre = (String) request.getParameter("Mod_Codigo");
                                Vector x;
                                x = Premios_Modificar_GIBM.DatosGIBM(Pre);
                                Premios_Modificar_GIBM p = (Premios_Modificar_GIBM) x.get(0);
                    ...
                    <table width="1034" height="40" align="center">
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="ID_Premios_GIBM" type="text" id="ID_Premios_GIBM" size="10" maxlength="4" class="Cajas" readonly="readonly"   value="<%=p.getID()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Evento_Premios_GIBM" type="text" id="Evento_Premios_GIBM" size="100" maxlength="150" class="Cajas" placeholder="Evento que lo otorga..."value="<%=p.getEvento()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Premios_Premios_GIBM" type="text" class="Cajas" id="Premios_Premios_GIBM" size="30" maxlength="30" placeholder="Premio obtenido..."value="<%=p.getNombre_Pre_GIBM()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="250" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Trabajo_Premios_GIBM" type="text" class="Cajas" id="Trabajo_Premios_GIBM" size="100" maxlength="150" placeholder="Trabajo o proyecto..."value="<%=p.getTrabajo()%>">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td height="40" class="Estilo6">
                                <select name="Categoria_Premios_GIBM" class="Cajas">
                        ...
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><input name="Grupo_Premios_GIBM" type="text" class="Cajas" id="Grupo_Premios_GIBM" size="3" maxlength="3"value="<%=p.getGrupo()%>"placeholder="Grupo..." onkeypress="if(event.keyCode<=45 || event.keyCode>57) event.returnValue=false;"></td>
                        </tr>
                    </table>
                    <p>&nbsp;</p>
                </div>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Actualizar_Premios_GIBM" type="submit" id="Actualizar_Premios_GIBM" value="Actualizar" class="Boton" onclick="confirmacion();"/>
                </label>
                <label></label>
                <label></label>
            </p>
