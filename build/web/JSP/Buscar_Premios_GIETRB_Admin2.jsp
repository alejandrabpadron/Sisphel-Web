<%@page import="Operaciones.Buscar_Premios"%>
...
<html>
    ...
    <head>
        ...
        <title>Búsqueda de Premios o Distinciones</title>
        <link rel="icon" type="image/png" href="Img/ICONO.png"/>
        <script language="javascript">

            function EnviarID(Codigo){
                var ab=Codigo;
                window.open ("/SisphelWeb/JSP/Modificar_Premios_GIETRB_Admin.jsp?Mod_Codigo="+ab, "mywindow");
            }
        </script>
                ...
                <div class="hb-content-wrapper">
                    <div class="hb-text-wrapper">
                        <div class="hb-headline-text">
                            <p><span>Selecciona el premio o distinción a modificar.</span></p>
                        </div>
                    </div>
                </div>
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Pre_GIBM" type="text" class="Boton21" id="Nombre_Pre_GIBM">
                                </span>
                            </span>
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Premio_GIBM" type="submit" id="Buscar_Premio_GIBM" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
            ...
            <center><div>
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            ...
                            <td width="106" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">ID</div>
                                </div></td>
                            <td width="286" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">EVENTO</div>
                                </div></td>
                            <td width="276" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">PREMIO</div></td>
                            <td width="212" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">TRABAJO</div>
                                </div></td>
                            <td width="230" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">CATEGORÍA</div></td>

                        </tr> 
                        <%
                                    Vector e;
                                    e = (Vector) request.getAttribute("Premios");
                                    for (int i = 0; i < e.size(); i++) {

                                        Buscar_Premios p = (Buscar_Premios) e.get(i);

                        %>
                        <tr>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><a href="javascript:EnviarID('<%=p.getID()%>');"/><%=p.getID()%></span></div></td>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getEvento()%></span></div></td>
                            <td><div align="center" class="Estilo6"><%=p.getNombre_Pre_GIETRB()%></div></td>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getTrabajo()%></span></div></td>
                            <td><div align="center" class="Estilo6"><%=p.getCategoria()%></div></td>
                        </tr> <%
                                    }
                        %>
                    </table>
