...
<html>
    <style type="text/css">
        ...
        * {
        ...
        .slider ul {
            ...
            animation: 20s infinite alternate linear;
        }
    ...
    <head>
        <title>Menú Principal | Proyectos</title>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <center><img  src="/SisphelWeb/Img/banner1.png" onmouseover="this.src='/SisphelWeb/Img/banner2.png';" onmouseout="this.src='/SisphelWeb/Img/banner3.png';" width="1146"></center>
            <div>
                <center><img src="/SisphelWeb/Img/LOGO_UNISINU.png" width=""></center>
            </div>
