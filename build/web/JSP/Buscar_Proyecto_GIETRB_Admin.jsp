            ...
            <p><span class="Boton1">
                    ...
                    <label>
                        <div class="Buscar">
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Pro_GIETRB" type="text" class="Boton21" id="Nombre_Pro_GIETRB" placeholder="Nombre del proyecto...">
                                </span>
                            </span>
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Proyecto_GIETRB" type="submit" id="Buscar_Proyecto_GIETRB" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
