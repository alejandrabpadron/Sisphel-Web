<%@page import="Operaciones.Consultar_Premios"%>
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">PREMIOS Y DISTINCIONES</h1></div>
            <br>
            <div id="obj2">
                    ...
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            <td width="548" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">EVENTO - INSTITUCIÓN QUE LO OTORGA</div>
                                </div></td>
                            <td width="551" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">PREMIO</div></td>
                            <td width="548" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">TRABAJO</div>
                                </div></td>
                            <td width="551" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">CATEGORÍA</div></td>
                        </tr>
                        <%Vector e;
                                    ...
                                    for (int i = 0; i < e.size(); i++) {
                                        ...
                                        Consultar_Premios p = (Consultar_Premios) e.get(i);


                        %>
                        <tr>
                            <td><div align="center" class="Estilo6"><span class="Estilo6"><%=p.getEvento()%></span></div></td>
                            <td><div align="center" class="Estilo6"><%=p.getPremio()%></div></td>
            ...
            <p align="center" class="Boton">
                <label>
                    <input name="Insertar_Premios_GIETRB" type="submit" id="Insertar_Premios_GIETRB" value="Insertar" class="Boton"/>
                </label>
                <label>
                    <input name="Modificar_Premios_GIETRB" type="submit" id="Modificar_Premios_GIETRB" value="Modificar" class="Boton"/>
                </label>
            </p>
        </form>
    </body>
