    ...
    <head>
        <SCRIPT language="JavaScript" >
            function verificar( servi ){
                servi.Titulo_Noticia.focus();
                if ( servi.Titulo_Noticia.value == ""){
                    alert( "Faltan el Título");
                    servi.Titulo_Noticia.focus();
                    return false;
                }
                if ( servi.Codigo_Noticia.value == ""){
                    alert( "Falta el Código" );
                    servi.Codigo_Noticia.focus();
                    return false;
                }
                if ( servi.Cuerpo_Noticia.value == ""){
                    alert( "Falta el Cuerpo" );
                    servi.Cuerpo_Noticia.focus();
                    return false;
                }
                return true;
            }
    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">NUEVA NOTICIA</h1></div>
            <br>
            <div id="obj2">
        ...
        <form name="servi" method="post" action="Servlet_Proyectos_Admin"onSubmit="return verificar(this)">
                    ...
                    <table width="1034" height="214" align="center">
                        <tr>
                            ...
                            <td width="725" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Fecha_Noticia" type="text" id="Fecha_Noticia" size="20" maxlength="20" class="Cajas" value="<%="" + año + "-" + mes + "-" + dia%>" readonly="readonly" >
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="725" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Titulo_Noticia" type="text" class="Cajas" id="Titulo_Noticia" size="100" maxlength="100">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td width="725" height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Codigo_Noticia" type="text" class="Cajas" id="Codigo_Noticia" size="30" maxlength="12">
                                    </div>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><label>
                                    <textarea name="Cuerpo_Noticia" cols="101" rows="10" class="Cajas" id="Cuerpo_Noticia" style="resize: none;"></textarea>
                                </label></td>
                        </tr>
                        <tr>
                            ...
                            <td height="40" class="Estilo6"><label>
                                    ...
                                    <div align="left">
                                        <input name="Imagen_Noticia" type="text" class="Cajas" id="Imagen_Noticia" size="100" maxlength="100">
                                    </div>
                                </label></td>
                        </tr>
                    </table>
            ...
            <p align="center" class="Boton">
                <label><span class="Boton">
                        <input name="Guardar_Noticia" type="submit" id="Guardar_Noticia" value="Guardar" class="Boton" onclick="alert('Nueva noticia agregad exitosamente')"/>
                    </span></label>
                <label></label>
                <label></label>
            </p>
