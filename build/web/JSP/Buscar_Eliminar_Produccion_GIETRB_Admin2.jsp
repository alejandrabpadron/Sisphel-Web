<%@page import="Operaciones.Buscar_Produccion"%>
    ...
    <head>
        ...
        <script language="javascript">
            ...
            function EnviarID(Codigo){
                var ab=Codigo;
                window.open ("/SisphelWeb/JSP/Eliminar_Produccion_GIETRB_Admin.jsp?Eli_Codigo="+ab, "mywindow");
            }
        </script>
                ...
                <div class="hb-content-wrapper">
                    <div class="hb-text-wrapper">
                        <div class="hb-headline-text">
                            <p><span>Selecciona la producción científica a eliminar.</span></p>
                        </div>
                    </div>
                </div>
            ...
            <p><span class="Boton1">
                    <label>
                        <div class="Buscar">   
                            <span class="Boton12">
                                <span class="Boton111">
                                    <input name="Nombre_Prod_GIETRB" type="text" class="Boton21" id="Nombre_Prod_GIETRB" placeholder="Nombre del avance...">
                                </span>
                            </span>
                            <span class="Boton14"><span class="Boton131">
                                    <input name="Buscar_Produccion_GIETRB" type="submit" id="Buscar_Produccion_GIETRB" value="Buscar" class="Boton131"/>
                                </span>
                            </span>
                        </div>
                    </label>
            ...
            <center><div>
                    <table border="1" width=1146 id="tabla" style="border-collapse: collapse">
                        <tr>
                            ...
                            <td width="551" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">TÍTULO</div></td>
                            <td width="548" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">REVISTA-JOURNAL</div>
                                </div></td>
                            <td width="551" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">TIPO DE PUBLICACIÓN</div></td>
                            <td width="548" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">
                                    <div align="center">AÑO</div>
                                </div></td>
                            <td width="551" height="30" bgcolor="#CCCCCC"><div align="center" class="Estilo5">SITIO WEB</div></td>
                        </tr> 
                        <%
                                    Vector e;
                                    ...
                                    for (int i = 0; i < e.size(); i++) {
                                        ...
                                        Buscar_Produccion p = (Buscar_Produccion) e.get(i);
                        ...
                        <tr>
                            ...
                            <td><div align="center" class="Estilo6"><%=p.getNombre_Prod_GIBM()%></div></td>
