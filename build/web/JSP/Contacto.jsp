    ...
    <body>
        <form name="form1" method="post" action="Servlet_Proyectos_Admin">
            ...
            <div id ="obj">
                <br>
                &nbsp;&nbsp;
                <h1 align="center">COMUNICACIONES LABORATORIO</h1></div>
            <br>
            <div id="obj2">
            ...
            <center>
                <div id="div_contacto">
                    <div id="texto" align="left">
                        ...
                        <p class="Estilo12">Este formulario de contacto es un canal de comunicaci&oacute;n directa con nuestro laboratorio. </p>
                        <p class="Estilo12">&nbsp;</p>
                        <p class="Estilo12">Laboratorio de Investigaciones Biomédicas y Biología Molecular. </p>
                        <p class="Estilo12">Universidad del Sin&uacute; - El&iacute;as Bechara Zain&uacute;m</p>
                        <p class="Estilo12">Facultad de Ciencias de la Salud</p>
                        <p class="Estilo12">&nbsp;</p>
                        <p class="Estilo12"></p>
                    </div>
                    <br>
